<template>
  <div class="data-source-input-container">
    ...
    <div v-if="showForm" class="input-form">
      ...
      <!-- Generic URL input (not for OGC or Mapzen) -->
      <div v-if="selectedType && selectedType !== 'ogc-api-features' && selectedType !== 'mapzen-terrarium-png'" class="form-group">
...
export default {
  ...
  computed: {
    isInputValid() {
      ...
      return !!this.url; // For other types
    }
  },
  methods: {
    toggleForm() {
    ...
    handleAddLayer() {
      ...
      if (this.selectedType === 'ogc-api-features') {
        ...
        payload.auth = {
          type: this.ogcAuthType,
          token: this.ogcToken,
          username: this.ogcUsername,
          password: this.ogcPassword,
        };
